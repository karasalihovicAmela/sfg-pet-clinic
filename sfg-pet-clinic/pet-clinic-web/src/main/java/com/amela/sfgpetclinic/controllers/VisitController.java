...
public class VisitController {
    ...
    public void dataBinder(WebDataBinder dataBinder){
        ...
        dataBinder.registerCustomEditor(Local.class, new PropertyEditorSupport(){
            @Override
    ...
    public Visit loadPetWitVisit(@PathVariable("petId") Long petId, Map<String, Object> model){
